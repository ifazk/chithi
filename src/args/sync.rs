...
use crate::send_recv_opts::{OptionsLine, Opts};
use crate::zfs;
use bw::Bytes;
...
pub struct SyncArgs {
    ...
    #[arg(long, value_name = "EXTRA", value_parser = SyncArgs::validate_identifier)]
    ...
    /// documentation.
    #[arg(long, default_value="%Y-%m-%d:%H:%M:%S-GMT%:z", value_parser = SyncArgs::validate_timestamp)]
    ...
    #[arg(long, value_parser = SyncArgs::get_commands_to_skip, default_value = "")]
