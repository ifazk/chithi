...
use crate::sync_pipelines::OptionalCommands;
use crate::sys::hostname;
use crate::util::ReadableBytes;
use crate::zfs::{Creation, IntermediateSource, Snapshot, SnapshotInfo};
...
pub fn main(args: SyncArgs) -> io::Result<()> {
    if args.recursive
        && args
            .send_options
            .options
